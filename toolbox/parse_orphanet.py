import urllib.request, urllib.error, urllib.parse, os, pickle
from bs4 import BeautifulSoup
import time
from xml.etree.ElementTree import iterparse, tostring
from . import parse_uniprot
...
def main():
    ...
    uniprot_ids = list(gene_to_uniprot.values()) #reduce(lambda x,y: x+y, gene_to_uniprot.values())
